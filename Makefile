...
pkgdatadir = $(datadir)/advantagecoin
pkgincludedir = $(includedir)/advantagecoin
pkglibdir = $(libdir)/advantagecoin
pkglibexecdir = $(libexecdir)/advantagecoin
...
CONFIG_HEADER = $(top_builddir)/src/config/advantagecredit-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/advantagecredit-config.h.in \
...
ACLOCAL = ${SHELL} /home/advantage/v6/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/advantage/v6/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/advantage/v6/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/advantage/v6/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/advantage/v6/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = advantagecoin
PACKAGE_BUGREPORT = www.advantagecoin.org
PACKAGE_NAME = AdvantageCoin Core
PACKAGE_STRING = AdvantageCoin Core 1.0.0
PACKAGE_TARNAME = advantagecoin
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/advantage/v6
abs_srcdir = /home/advantage/v6
abs_top_builddir = /home/advantage/v6
abs_top_srcdir = /home/advantage/v6
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/advantage/v6/build-aux/install-sh
...
SUBDIRS = src
BITCREDITD_BIN = $(top_builddir)/src/advantagecoind$(EXEEXT)
BITCREDIT_QT_BIN = $(top_builddir)/src/qt/advantagecoin-qt$(EXEEXT)
BITCREDIT_CLI_BIN = $(top_builddir)/src/advantagecoin-cli$(EXEEXT)
BITCREDIT_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = AdvantageCoin-Qt.app
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_advantagecoin_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_advantagecoin_coverage.info test_advantagecoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcredit.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/AdvantageCoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/advantagecredit-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/advantagecredit-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/advantagecredit-config.h
$(top_srcdir)/src/config/advantagecredit-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/advantagecredit-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/AdvantageCoin-Qt: $(BITCREDIT_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/AdvantageCoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/AdvantageCoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_advantagecoin.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_advantagecoin -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_advantagecoin_filtered.info: test_advantagecoin.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_advantagecoin_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_advantagecoin_coverage.info: baseline_filtered_combined.info test_advantagecoin_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_advantagecoin_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_advantagecoin_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_advantagecoin_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_advantagecoin.coverage/.dirstamp:  test_advantagecoin_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_advantagecoin.coverage/.dirstamp total.coverage/.dirstamp

# AdvantageCoin: disable the outdated comparison tool test
...
clean-local:
	rm -rf test_advantagecoin.coverage/ total.coverage/ $(OSX_APP)
