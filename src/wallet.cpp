 ...
 */
void CWallet::AvailableCredits(vector<COutput>& vCredits, bool fOnlyConfirmed, const CCreditControl* coinControl, bool fIncludeZeroValue, AvailableCreditsType nCoinType, bool fUseIX) const
{
    vCredits.clear();
...
bool CWallet::SelectCredits(const CAmount& nTargetValue, set<pair<const CWalletTx*, unsigned int> >& setCreditsRet, CAmount& nValueRet, const CCreditControl* coinControl, AvailableCreditsType coin_type, bool useIX) const
{
...
{
    CCreditControl* coinControl = NULL;
...
bool CWallet::CreateTransaction(const vector<pair<CScript, CAmount> >& vecSend,
    ...
    const CCreditControl* coinControl,
...
bool CWallet::CreateTransaction(CScript scriptPubKey, const CAmount& nValue, CWalletTx& wtxNew, CReserveKey& reservekey, CAmount& nFeeRet, std::string& strFailReason, const CCreditControl* coinControl, AvailableCreditsType coin_type, bool useIX, CAmount nFeePay)
{
    vector<pair<CScript, CAmount> > vecSend;
...
void CWallet::AutoCombineDust()
{
    ...
    for (map<CBitcreditAddress, vector<COutput> >::iterator it = mapCreditsByAddress.begin(); it != mapCreditsByAddress.end(); it++) {
        ...
        CCreditControl* coinControl = new CCreditControl();
...
bool CWallet::MultiSend()
{
    ...
    BOOST_FOREACH (const COutput& out, vCredits) {
        ...
        CCreditControl* cControl = new CCreditControl();
        COutPoint outpt(out.tx->GetHash(), out.i);
