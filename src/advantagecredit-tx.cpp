...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("AdvantageCoin Core advantagecredit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  advantagecredit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded advantagecredit transaction") + "\n" +
                               "  advantagecredit-tx [options] -create [commands]   " + _("Create hex-encoded advantagecredit transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded advantagecredit transaction
