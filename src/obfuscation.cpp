    ...
    if (fMasterNode) {
        ...
        BOOST_FOREACH (const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat AdvantageCoin and make it unusable. To
...
bool CObfuscationPool::DoAutomaticDenominating(bool fDryRun)
{
    ...
    CAmount nBalanceNeedsAnonymized = nAnonymizeAdvantageCoinAmount * CREDIT - pwalletMain->GetAnonymizedBalance();
...
bool CObfuscationPool::MakeCollateralAmounts()
{
    ...
    if (!success) {
        ...
        CCreditControl* coinControlNull = NULL;
...
void ThreadCheckObfuScationPool()
{
    ...
    RenameThread("advantagecredit-obfuscation");
