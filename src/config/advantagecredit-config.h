/* src/config/advantagecredit-config.h.  Generated from advantagecredit-config.h.in by configure.  */
/* src/config/advantagecredit-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.advantagecoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "AdvantageCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "AdvantageCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "advantagecoin"
