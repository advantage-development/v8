...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop AdvantageCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "AdvantageCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AdvantageCoin features */
        {"advantagecredit", "masternode", &masternode, true, true, false},
        {"advantagecredit", "listmasternodes", &listmasternodes, true, true, false},
        {"advantagecredit", "getmasternodecount", &getmasternodecount, true, true, false},
        {"advantagecredit", "masternodeconnect", &masternodeconnect, true, true, false},
        {"advantagecredit", "masternodecurrent", &masternodecurrent, true, true, false},
        {"advantagecredit", "masternodedebug", &masternodedebug, true, true, false},
        {"advantagecredit", "startmasternode", &startmasternode, true, true, false},
        {"advantagecredit", "createmasternodekey", &createmasternodekey, true, true, false},
        {"advantagecredit", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"advantagecredit", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"advantagecredit", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"advantagecredit", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"advantagecredit", "getmasternodescores", &getmasternodescores, true, true, false},
        {"advantagecredit", "mnbudget", &mnbudget, true, true, false},
        {"advantagecredit", "preparebudget", &preparebudget, true, true, false},
        {"advantagecredit", "submitbudget", &submitbudget, true, true, false},
        {"advantagecredit", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"advantagecredit", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"advantagecredit", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"advantagecredit", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"advantagecredit", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"advantagecredit", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"advantagecredit", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"advantagecredit", "checkbudgets", &checkbudgets, true, true, false},
        {"advantagecredit", "mnsync", &mnsync, true, true, false},
        {"advantagecredit", "spork", &spork, true, true, false},
        {"advantagecredit", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"advantagecredit", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use advantagecreditd, or the -server option to advantagecredit-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> advantagecredit-cli " + methodname + " " + args + "\n";
}
