...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->coinControlFeatures, OptionsModel::CreditControlFeatures);
...
/* Window */
    ...
    mapper->addMapping(ui->anonymizeAdvantageCoin, OptionsModel::AnonymizeAdvantageCoinAmount);
