...
/** Utility functions used by the AdvantageCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render AdvantageCoin addresses in monospace font
...
// Parse "advantagecredit:" URI into recipient object, return true on successful parsing
