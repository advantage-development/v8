...
public:
    ...
    QLabel *label_2;
    QSpinBox *anonymizeAdvantageCoin;
    QWidget *tabWallet;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeAdvantageCoin = new QSpinBox(tabMain);
        anonymizeAdvantageCoin->setObjectName(QStringLiteral("anonymizeAdvantageCoin"));
        anonymizeAdvantageCoin->setMinimum(100);
        anonymizeAdvantageCoin->setMaximum(100000);
        anonymizeAdvantageCoin->setSingleStep(100);
        anonymizeAdvantageCoin->setValue(1000);

        horizontalLayout->addWidget(anonymizeAdvantageCoin);
...
#ifndef QT_NO_TOOLTIP
        bitcreditAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start AdvantageCoin after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcreditAtStartup->setText(QApplication::translate("OptionsDialog", "&Start AdvantageCoin on system login", 0));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of AdvantageCoin to keep anonymized", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the AdvantageCoin client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the AdvantageCoin network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting AdvantageCoin.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/advantagecredit-project/advantagecredit-project-translations", 0));
