...
public:
    ...
    void setupUi(QDialog *HelpMessageDialog)
    {
        ...
        HelpMessageDialog->resize(585, 399);
        QFont font;
        font.setPointSize(10);
        HelpMessageDialog->setFont(font);
        HelpMessageDialog->setWindowTitle(QStringLiteral("AdvantageCoin Core - Command-line options"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 476, 149));
