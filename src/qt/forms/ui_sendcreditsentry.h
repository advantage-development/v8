...
public:
    ...
    void setupUi(QStackedWidget *SendCreditsEntry)
    {
        ...
        payAmount = new BitcoinAmountField(SendCredits);
        ...
        payAmount_is = new BitcoinAmountField(SendCredits_InsecurePaymentRequest);
        ...
        payAmount_s = new BitcoinAmountField(SendCredits_SecurePaymentRequest);
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCreditsEntry", "The AdvantageCoin address to send the payment to", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCreditsEntry", "A message that was attached to the AdvantageCoin: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the AdvantageCoin network.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
